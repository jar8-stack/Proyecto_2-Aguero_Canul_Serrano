...
interface Score_per_match_Dao {
    ...
    @Query("INSERT INTO score_per_match(id_usuario, score_per_match, date_match) VALUES(:idUsuario, :score_perMatch, :date)")
    fun insertUser(idUsuario:Int,score_perMatch:Int,date: String)
}